                ...
                <div class="reveal-item glass-card relative overflow-hidden rounded-[2rem] p-6 sm:p-8" data-reveal style="transition-delay:120ms;">
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h2 class="mt-1 font-display text-3xl font-bold text-shelf-ink">Masuk Akun</h2>
                            <p class="mt-0.5 text-sm text-shelf-ink/68">Silakan login untuk melanjutkan perjalanan literasi.</p>
                        </div>
                    </div>
