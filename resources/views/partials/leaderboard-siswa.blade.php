...
<section class="relative mt-4 overflow-hidden rounded-3xl border border-slate-200/80 bg-gradient-to-br from-white/95 via-sky-50/70 to-teal-50/70 p-4 shadow-[0_18px_35px_rgba(16,23,46,0.08)] sm:p-6">
    ...
    <div class="relative z-10 flex flex-wrap items-start justify-between gap-3">
        <div>
            <p class="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">Leaderboard Live</p>
            <h3 class="mt-1 font-display text-lg leading-tight text-slate-900 sm:text-xl">Peminjam Buku Teraktif</h3>
            <p class="mt-1 max-w-2xl text-sm text-slate-600">Ranking diperbarui mengikuti total transaksi peminjaman buku terbaru.</p>
        ...
        >
            ...
            <span class="lbx-meta-text">Refresh Data</span>
        </button>
    </div>
    ...
    <div class="relative z-10 mt-4 grid gap-3 sm:grid-cols-3">
        <article class="rounded-2xl border border-slate-200/80 bg-white/85 px-4 py-3">
            <p class="text-[11px] font-extrabold uppercase tracking-[0.14em] text-slate-500">Peserta</p>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center text-sm font-semibold text-slate-500">
                                Belum ada data peminjaman siswa untuk ditampilkan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
