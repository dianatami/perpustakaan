...
<div class="container-fluid py-4">
    ...
    <div class="admin-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1><i class="bi bi-cash-stack"></i> Laporan Denda</h1>
            <p>Rekapitulasi pencatatan denda akibat keterlambatan, kehilangan, atau kerusakan buku.</p>
        </div>
    ...
    <div class="table-wrapper">
        <h4 class="table-title">
            <i class="bi bi-file-earmark-spreadsheet"></i> Rekapitulasi Data Penerimaan Denda
        </h4>
        ...
        @else
            <div class="text-center py-5">
                ...
                <p class="text-muted mt-3">Tidak ada data denda terekam</p>
            </div>
        @endif
    </div>
</div>
