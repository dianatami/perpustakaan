...
<div class="container-fluid py-4">
    ...
    <div class="admin-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h1><i class="bi bi-file-earmark-arrow-up-fill"></i> Laporan Peminjaman</h1>
            <p>Rekapitulasi dan laporan pencatatan transaksi peminjaman buku perpustakaan.</p>
        </div>
    ...
    <div class="table-wrapper">
        <h4 class="table-title">
            <i class="bi bi-file-earmark-spreadsheet"></i> Rekapitulasi Data Peminjaman
        </h4>
        ...
        @else
            <div class="text-center py-5">
                ...
                <p class="text-muted mt-3">Tidak ada data peminjaman buku untuk dilaporkan</p>
            </div>
        @endif
    </div>
</div>
